...
<div
  id="side-bar"
  class="w-full h-full  flex flex-row justify-evenly items-center md:flex-col  md:space-y-4  md:pt-20 md:pb-10 "
>
  <div class="menu-item active ">
    <Icon name="home" class={"w-full h-full"} />
  </div>
  <div class="menu-item">
    <Icon name="chat" class={"w-full h-full"} />
  </div>
  <div class="menu-item">
    <Icon name="wallet" class={"w-full h-full"} />
  </div>
  <div class="menu-item">
    <Icon name="heart" class={"w-full h-full"} />
  </div>
  <div class="menu-item">
    <Icon name="doc" class={"w-full h-full"} />
  </div>
  <div class="menu-item">
...
<style>
  .menu-item {
    @apply w-12 h-12 md:w-14 md:h-14 flex-none p-3 md:p-4  container cursor-pointer rounded-full hover:bg-gray-100;
  }
  .menu-item.active {
    @apply bg-orange-400 hover:bg-orange-500 text-white;
    --tw-shadow: 0 4px 6px -1px rgba(235, 88, 9, 0.1),
      0 2px 4px -1px rgba(235, 88, 9, 0.2);
